...
namespace hunterview.Controllers
{
    public class StatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StatusId,AddDate,Content,Title,Valid")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusId,AddDate,Content,Title,Valid")] Status status)
        {
